...
function renderInitialData(students) {
  students.map(student => {
    ...
    itKnowledgeElement.innerHTML = `<strong>IT Knowledge:</strong> <span class="student-itknowledge">${studentItKnowledge}</span>`;
...
searchForm.addEventListener('submit', (event) => {
  ...
  allStudents.forEach(student => {
    ...
    let studentItKnowledge = student.querySelector('.student-itknowledge').textContent;
